<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="NewTask.aspx.cs" Inherits="Tier_1_WebUI.Addition.NewTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphHeader" runat="server">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><i class="fa fa-plus"></i>New Addition Task</li>
    </ol>
</asp:Content>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="row m-t-10">
                        <div class="col-lg-6 text-right">Value A</div>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" id="tbValueA" required value="" />
                        </div>
                    </div>
                    <div class="row m-t-10">
                        <div class="col-lg-6 text-right">Value B</div>
                        <div class="col-lg-6">
                            <input class="form-control" type="text" id="tbValueB" required value="" />
                        </div>
                    </div>
                    <hr />
                    <div class="row m-t-40">
    ...
    <script>
        $(function () {
            ...
            $("#btnGenerateTask").click(function (e) {
                ...
                var obj = {};
                obj.sTaskName = $('#tbTaskName').val() || "Addition Task";
                obj.oInput = {};
                obj.oInput.ValueA = $('#tbValueA').val();
                obj.oInput.ValueB = $('#tbValueB').val();

                $.ajax({
                    type: "POST",
                    url: "/Async.asmx/CreateAdditionTask",
